...
/****** Object:  Job [RunMediAssistTrackerProcesses_ETL]    Script Date: 7/28/2026 12:54:39 AM ******/
BEGIN TRANSACTION
DECLARE @ReturnCode INT
SELECT @ReturnCode = 0
/****** Object:  JobCategory [[Uncategorized (Local)]]    Script Date: 7/28/2026 12:54:39 AM ******/
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [01_Sp_PatientRefresh_ETL_Test]    Script Date: 7/28/2026 12:54:39 AM ******/
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'01_Sp_PatientRefresh_ETL_Test', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [01_Sp_PatientRefresh_ETL_PROD]    Script Date: 7/28/2026 12:54:39 AM ******/
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'01_Sp_PatientRefresh_ETL_PROD', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [02_sp_TotalLibertyinfoPast9Months_ETL_Test]    Script Date: 7/28/2026 12:54:39 AM ******/
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'02_sp_TotalLibertyinfoPast9Months_ETL_Test', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [02_sp_TotalLibertyinfoPast9Months_ETL_PROD]    Script Date: 7/28/2026 12:54:39 AM ******/
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'02_sp_TotalLibertyinfoPast9Months_ETL_PROD', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [03_SP_RXQPatients_ETL_Test]    Script Date: 7/28/2026 12:54:39 AM ******/
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'03_SP_RXQPatients_ETL_Test', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [03_SP_RXQPatients_ETL_PROD]    Script Date: 7/28/2026 12:54:39 AM ******/
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'03_SP_RXQPatients_ETL_PROD', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [04_sp_LibertyinfoPast9Months_ETL_Test]    Script Date: 7/28/2026 12:54:39 AM ******/
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'04_sp_LibertyinfoPast9Months_ETL_Test', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [04_sp_LibertyinfoPast9Months_ETL_Prod]    Script Date: 7/28/2026 12:54:39 AM ******/
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'04_sp_LibertyinfoPast9Months_ETL_Prod', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [05_SP_Patientmedication_ETL_Test]    Script Date: 7/28/2026 12:54:39 AM ******/
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'05_SP_Patientmedication_ETL_Test', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [05_SP_Patientmedication_ETL_Prod]    Script Date: 7/28/2026 12:54:39 AM ******/
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'05_SP_Patientmedication_ETL_Prod', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [06 Load Drug and Presciber Names Master Test]    Script Date: 7/28/2026 12:54:39 AM ******/
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'06 Load Drug and Presciber Names Master Test', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [06 Load Drug and Prescriber Names Master Prod]    Script Date: 7/28/2026 12:54:39 AM ******/
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'06 Load Drug and Prescriber Names Master Prod', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [07 Load RXQ Visit Dates Test]    Script Date: 7/28/2026 12:54:39 AM ******/
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'07 Load RXQ Visit Dates Test', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [07 Load RXQ Visit Dates Prod]    Script Date: 7/28/2026 12:54:39 AM ******/
